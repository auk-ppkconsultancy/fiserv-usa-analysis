...
//*** Send GMF XML Payload to Datawire using HTTP POST protocol ***//
...
function CreateCreditSaleRequest()
{
	...
	$obj_CommonGrp -> setLocalDateTime("20260214042651");	//Local Txn Date-Time
	$obj_CommonGrp -> setTrnmsnDateTime("20260214042651");	//Local Transmission Date-Time
	...
	$obj_CommonGrp -> setMerchID("XXXXXX");	//Merchant ID
...
{	//create XML serializer instance using PEAR
    ...
    $serializer = new XML_Serializer(array("indent" => ""));
	$serializer->setOption("rootAttributes", array("xmlns:xsi" => "http://www.w3.org/2001/XMLSchema-instance",
													"xmlns:xsd" =>"http://www.w3.org/2001/XMLSchema",
													"xmlns" => "com/fiserv/Merchant/gmfV10.02"));
...
function SendMessage($gmfXMLPayload, $clientRef)
{
	...
	<ReqClientID><DID>00010774080220390428</DID><App>RAPIDCONNECTVXN</App><Auth>RCTST0000000001|00000002</Auth>

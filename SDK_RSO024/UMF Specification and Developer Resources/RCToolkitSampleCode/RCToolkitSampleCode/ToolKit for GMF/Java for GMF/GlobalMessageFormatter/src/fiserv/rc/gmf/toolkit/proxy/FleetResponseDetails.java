 ...
 *         &lt;element name="EnhdFltGrp" type="{com/fiserv/Merchant/gmfV15.04}EnhdFltGrp" minOccurs="0"/>
 *         &lt;element name="EnhdFltProdLimitGrp" type="{com/fiserv/Merchant/gmfV15.04}EnhdFltProdLimitGrp" maxOccurs="20" minOccurs="0"/>
 *         &lt;element name="EnhdFltPromptGrp" type="{com/fiserv/Merchant/gmfV15.04}EnhdFltPromptGrp" maxOccurs="11" minOccurs="0"/>
 ...
 *         &lt;element name="OTRFuelLimitGrp" type="{com/fiserv/Merchant/gmfV15.04}OTRFuelLimitGrp" maxOccurs="12" minOccurs="0"/>
...
public class FleetResponseDetails {
    ...
    @XmlElement(name = "EnhdFltGrp")
    protected EnhdFltGrp enhdFltGrp;
    @XmlElement(name = "EnhdFltProdLimitGrp")
    protected List<EnhdFltProdLimitGrp> enhdFltProdLimitGrp;
    @XmlElement(name = "EnhdFltPromptGrp")
    protected List<EnhdFltPromptGrp> enhdFltPromptGrp;
    ...
    /**
     * Gets the value of the enhdFltGrp property.
     * 
     * @return
     *     possible object is
     *     {@link EnhdFltGrp }
     *     
     */
    public EnhdFltGrp getEnhdFltGrp() {
        return enhdFltGrp;
    }

    /**
     * Sets the value of the enhdFltGrp property.
     * 
     * @param value
     *     allowed object is
     *     {@link EnhdFltGrp }
     *     
     */
    public void setEnhdFltGrp(EnhdFltGrp value) {
        this.enhdFltGrp = value;
    }

    /**
     * Gets the value of the enhdFltProdLimitGrp property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the enhdFltProdLimitGrp property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEnhdFltProdLimitGrp().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link EnhdFltProdLimitGrp }
     * 
     * 
     */
    public List<EnhdFltProdLimitGrp> getEnhdFltProdLimitGrp() {
        if (enhdFltProdLimitGrp == null) {
            enhdFltProdLimitGrp = new ArrayList<EnhdFltProdLimitGrp>();
        }
        return this.enhdFltProdLimitGrp;
    }

    /**
     * Gets the value of the enhdFltPromptGrp property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the enhdFltPromptGrp property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEnhdFltPromptGrp().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link EnhdFltPromptGrp }
     * 
     * 
     */
    public List<EnhdFltPromptGrp> getEnhdFltPromptGrp() {
        if (enhdFltPromptGrp == null) {
            enhdFltPromptGrp = new ArrayList<EnhdFltPromptGrp>();
        }
        return this.enhdFltPromptGrp;
    }

 ...
 *   &lt;restriction base="{com/fiserv/Merchant/gmfV15.04}Max14AN">
 *     &lt;enumeration value="SecDataMissing"/>
 *     &lt;enumeration value="SecDataInvalid"/>
 *     &lt;enumeration value="InvSecLvInd"/>
 *     &lt;enumeration value="XCodeProc"/>
 *   &lt;/restriction>
 * &lt;/simpleType>
 * </pre>
 * 
...
public enum SecDataDowngradeType {
    ...
    @XmlEnumValue("InvSecLvInd")
    INV_SEC_LV_IND("InvSecLvInd"),
    @XmlEnumValue("XCodeProc")
    X_CODE_PROC("XCodeProc");

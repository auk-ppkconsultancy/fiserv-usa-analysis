 ...
 *       &lt;sequence>
 *         &lt;element ref="{com/fiserv/Merchant/gmfV15.04}AmExPOSData" minOccurs="0"/>
 *         &lt;element ref="{com/fiserv/Merchant/gmfV15.04}AmExTranID" minOccurs="0"/>
 *         &lt;element ref="{com/fiserv/Merchant/gmfV15.04}GdSoldCd" minOccurs="0"/>
 *         &lt;element ref="{com/fiserv/Merchant/gmfV15.04}ReAuthInd" minOccurs="0"/>
 *         &lt;element ref="{com/fiserv/Merchant/gmfV15.04}AmexAuthInd" minOccurs="0"/>
 *         &lt;element ref="{com/fiserv/Merchant/gmfV15.04}StoredCrdInd" minOccurs="0"/>
 *         &lt;element ref="{com/fiserv/Merchant/gmfV15.04}AmexACI" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class AmexGrp {
    ...
    @XmlElement(name = "AmexACI")
    @XmlSchemaType(name = "string")
    protected AmexACIType amexACI;
    ...
    /**
     * Gets the value of the amexACI property.
     * 
     * @return
     *     possible object is
     *     {@link AmexACIType }
     *     
     */
    public AmexACIType getAmexACI() {
        return amexACI;
    }

    /**
     * Sets the value of the amexACI property.
     * 
     * @param value
     *     allowed object is
     *     {@link AmexACIType }
     *     
     */
    public void setAmexACI(AmexACIType value) {
        this.amexACI = value;
    }
